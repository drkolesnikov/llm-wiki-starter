---
name: llm-wiki
description: Initialize or inspect a visible namespaced llm-wiki workspace in a repository, then route future wiki/source/knowledge work through llm-wiki/AGENTS.md.
---
...
The installer creates a visible namespaced `llm-wiki/` workspace and creates or appends a root `AGENTS.md` pointer block. It never overwrites existing target files; conflicts are recorded in `llm-wiki/meta/install-report.md`.
