...
The [LLM Wiki pattern note](../knowledge/llm-wiki-pattern.md) demonstrates the v1 pattern: standard Markdown links for repository navigation, registered source IDs in frontmatter, and optional wikilinks for concepts.
